...
This implementation reproduces the core AutoML/model-comparison experiment as a lightweight, CPU-safe tabular classification run. It compares several scikit-learn models on the reproducible breast-cancer dataset bundled with scikit-learn and writes a ranked leaderboard plus test-set metrics.
