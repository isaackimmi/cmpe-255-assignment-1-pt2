...
from enterprise_audit import DEFAULT_AS_OF_DATE, LABEL_COLUMN, PREDICTION_TIME_COLUMN, SAFE_FEATURES, audit_dataset, generate_sample, write_report  # noqa: E402
...
def main() -> int:
    ...
    result = audit_dataset(csv_path, seed=255, as_of_date=DEFAULT_AS_OF_DATE, prediction_time_column=PREDICTION_TIME_COLUMN, label_column=LABEL_COLUMN, feature_manifest=SAFE_FEATURES)
